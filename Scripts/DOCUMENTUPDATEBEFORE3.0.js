/*------------------------------------------------------------------------------------------------------/
| Program : DocumentUpdateBefore.js
| Event   : DocumentUpdatedBefore
|
...
/------------------------------------------------------------------------------------------------------*/
var controlString = "DocumentUpdateBefore"; // Standard choice for control
...
var documentModel = aa.env.getValue("DocumentModel"); logDebug("documentModel = " + documentModel );
...
aa.print("docCapStatus ="+docCapStatus );
/*------------------------------------------------------------------------------------------------------/
