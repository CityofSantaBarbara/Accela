/*------------------------------------------------------------------------------------------------------/
| Program : DocumentReviewDeleteBefore3.0.js
| Event   : DocumentReviewDeleteBefore3.0
|
...
/------------------------------------------------------------------------------------------------------*/
var controlString = "DocumentReviewDeleteBefore"; // Standard choice for control
...
var docCapStatus;
aa.print(entityAssociationModels );
if(entityAssociationModels != null)
{
	...
	{
		var model = it.next();
		if("TASK" == model.getEntityType() && model.getID1()!=null && model.getID2()!=null  &&  model.getID3()!=null )
		{
			capObj = aa.cap.getCap(model.getID1(),model.getID2(),model.getID3()).getOutput();
			docCapStatus= capObj.getCapStatus();
		}
