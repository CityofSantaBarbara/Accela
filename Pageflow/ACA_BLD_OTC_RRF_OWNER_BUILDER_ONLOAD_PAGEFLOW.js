/*------------------------------------------------------------------------------------------------------/
| Program : ACA_BLD_OTC_RRF_ONLOAD_PAGEFLOW.js
| Event   : ACA_BLD_OTC_RRF_ONLOAD_PAGEFLOW Event
|
...
try {
   var hide = true;
    ...
    showDebug = true;
    logDebug("An error has occurred in ACA_BLD_OTC_RRF_ONLOAD_PAGEFLOW: Main function: " + err.message);
    logDebug(err.stack);
}
